...
Elm.CategoryBar.make = function (_elm) {
   ...
   if (_elm.CategoryBar.values) return _elm.CategoryBar.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   var Miscellaneous = {ctor: "Miscellaneous"};
   var Furniture = {ctor: "Furniture"};
   var Employment = {ctor: "Employment"};
   var Electronics = {ctor: "Electronics"};
   var Cars = {ctor: "Cars"};
   var Books = {ctor: "Books"};
   var Bikes = {ctor: "Bikes"};
   var Appliances = {ctor: "Appliances"};
...
Elm.Search.make = function (_elm) {
   ...
   var search_div_css = function (h) {    return _U.list([A2(_op["=>"],"line-height",toPixel(h))]);};
   ...
   var update = F2(function (action,query) {    var _p1 = action;if (_p1.ctor === "Search") {    return _p1._0;} else {    return "";}});
   var Reset = {ctor: "Reset"};
   var Search = function (a) {    return {ctor: "Search",_0: a};};
   var view = F4(function (_p2,col_limit,context,query) {
      var _p3 = _p2;
      var position = _U.cmp(col_limit,2) < 1 ? _U.list([]) : _U.list([A2(_op["=>"],"margin-left",toPixel(_p3._0))]);
      return A2($Html.div,
      _U.list([$Html$Attributes.style(A2($List.append,search_div_css(_p3._1),position))]),
      _U.list([A2($Html.input,
      _U.list([$Html$Attributes.placeholder("Search")
              ,$Html$Attributes.value(query)
              ,A2(onEnter,context.enter,$String.words(query))
              ,A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p4) {    return A2($Signal.message,context.input,Search(_p4));})
...
Elm.Header.make = function (_elm) {
   ...
   var container_css = _U.list([A2(_op["=>"],"margin-bottom","10px")
                               ,A2(_op["=>"],"background-color","#fff")
                               ,A2(_op["=>"],"border-radius","0px 0px 7px 7px")
                               ,A2(_op["=>"],"padding","0px 20px")]);
   var name_text_css = _U.list([A2(_op["=>"],"font-size","2em"),A2(_op["=>"],"margin","0px")]);
   var toPixel = function (x) {    return A2($Basics._op["++"],$Basics.toString(x),"px");};
   var logo_name_css = function (_p0) {
      var _p1 = _p0;
      return _U.list([A2(_op["=>"],"height",toPixel(_p1._1)),A2(_op["=>"],"width",toPixel(_p1._0)),A2(_op["=>"],"cursor","pointer")]);
   };
   ...
   var name_css = function (_p2) {
      var _p3 = _p2;
      return _U.list([A2(_op["=>"],"width",toPixel(_p3._0))
                     ,A2(_op["=>"],"margin","0px")
                     ,A2(_op["=>"],"display","table-cell")
                     ,A2(_op["=>"],"vertical-align","middle")
                     ,A2(_op["=>"],"height",toPixel(_p3._1))]);
   };
   var div_name = function (_p4) {
      var _p5 = _p4;
      return A2($Html.div,
   ...
   var div_logo = function (w) {    return A2($Html.div,_U.list([$Html$Attributes.style(logo_css(w))]),_U.list([]));};
   var div_logo_name = F3(function (_p6,col_limit,address) {
      var _p7 = _p6;
      var _p10 = _p7._1;
      var _p9 = _p7._0;
      var _p8 = _p7._2;
      var position = _U.cmp(col_limit,2) < 1 ? _U.list([A2(_op["=>"],"margin","0 auto")]) : _U.list([A2(_op["=>"],"float","left")]);
      return A2($Html.div,
      _U.list([$Html$Attributes.style(A2($List.append,logo_name_css({ctor: "_Tuple2",_0: _p9 + _p10,_1: _p8}),position))
...
Elm.HttpGetter.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var init = {listings: _U.list([])};
   var Listing = F8(function (a,b,c,d,e,f,g,h) {    return {key: a,title: b,body: c,price: d,categories: e,approved: f,sold: g,lastUpdated: h};});
   var listingDecoder = A9($Json$Decode.object8,
   Listing,
   ...
   A2($Json$Decode._op[":="],"categories",$Json$Decode.list($Json$Decode.string)),
   A2($Json$Decode._op[":="],"approved",$Json$Decode.bool),
   A2($Json$Decode._op[":="],"sold",$Json$Decode.bool),
   A2($Json$Decode._op[":="],"lastUpdate",$Json$Decode.string));
   var Blob = function (a) {    return {listings: a};};
   var blobDecoder = A2($Json$Decode.object1,Blob,A2($Json$Decode._op[":="],"listings",$Json$Decode.list(listingDecoder)));
   var getListings = function (url) {    return $Task.toMaybe(A2($Http.get,blobDecoder,url));};
   return _elm.HttpGetter.values = {_op: _op
                                   ,Blob: Blob
                                   ,Listing: Listing
                                   ,init: init
...
Elm.ImageViewer.make = function (_elm) {
   ...
   if (_elm.ImageViewer.values) return _elm.ImageViewer.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   return _elm.ImageViewer.values = {_op: _op
                                    ,Photo: Photo
                                    ,Left: Left
                                    ,Right: Right
                                    ,update: update
                                    ,image_view: image_view
                                    ,clicker_view: clicker_view
                                    ,view: view
                                    ,toPixel: toPixel
                                    ,image_CSS: image_CSS
...
Elm.Images.make = function (_elm) {
   ...
   if (_elm.Images.values) return _elm.Images.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var testImages = _U.list([_U.list([{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380398-712b9d35-73b9-44a5-a4ba-8ab5870db1e7-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380398-712b9d35-73b9-44a5-a4ba-8ab5870db1e7-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380398-86de6d19-0324-4335-ad23-a36c214f5eaa-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380398-86de6d19-0324-4335-ad23-a36c214f5eaa-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380399-9c943382-f497-4a11-9f6e-91e3d8b773bc-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380399-9c943382-f497-4a11-9f6e-91e3d8b773bc-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380399-231a5486-6caf-45dc-b47d-7df39156cd31-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380399-231a5486-6caf-45dc-b47d-7df39156cd31-small"}])
                            ,_U.list([{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380987-0c7437db-aad3-4624-bda3-c6589a251764-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452380987-0c7437db-aad3-4624-bda3-c6589a251764-small"}])
                            ,_U.list([{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452345601-1c2156ab-6d39-4c38-a3bf-c8c4188f3e8c-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452345601-1c2156ab-6d39-4c38-a3bf-c8c4188f3e8c-small"}])
                            ,_U.list([{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346150-168fc0ac-237f-4e9e-84b3-1bba62c9eaf9-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346150-168fc0ac-237f-4e9e-84b3-1bba62c9eaf9-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346151-4fd61993-fbbe-4881-a195-5191a79c6c0e-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346151-4fd61993-fbbe-4881-a195-5191a79c6c0e-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346151-a1f5b1a3-1c34-442c-af04-52970a4ff194-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346151-a1f5b1a3-1c34-442c-af04-52970a4ff194-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346151-d9c71425-de17-4ea5-a2b2-4c4b165ce068-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346151-d9c71425-de17-4ea5-a2b2-4c4b165ce068-small"}
                                     ,{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346152-bebd5b7e-1bcb-4737-a0ec-bc52b0b0ab22-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452346152-bebd5b7e-1bcb-4737-a0ec-bc52b0b0ab22-small"}])
                            ,_U.list([{large: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452319181-3486dc36-fc62-4b83-8ecd-e8c09cb0cef2-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1
"https://storage.googleapis.com/hosted-caravel.appspot.com/1452315038-81f1be2f-8815-4da3-b866-cb6d539223eb-large"
                                      ,small: "https://storage.googleapis.com/hosted-caravel.appspot.com/1452315038-81f1be2f-8815-4da3-b866-cb6d539223eb-small"}
...
Elm.Listing.make = function (_elm) {
   ...
   var category_tag_css = _U.list([A2(_op["=>"],"border-radius","8px")
                                  ...
                                  ,A2(_op["=>"],"font-size","100%")
                                  ,A2(_op["=>"],"color","#fff")
                                  ,A2(_op["=>"],"line-height","1.3")
                                  ,A2(_op["=>"],"text-align","center")
                                  ,A2(_op["=>"],"display","inline-block")
                                  ,A2(_op["=>"],"padding","5px 5px")
                                  ,A2(_op["=>"],"margin","2px 4px")]);
   var oneCategory = function (category) {    return A2($Html.span,_U.list([$Html$Attributes.style(category_tag_css)]),_U.list([$Html.text(category)]));};
   ...
   var thumbnail_container = function (col_percent) {
      return _U.list([A2(_op["=>"],"display","table-cell")
                     ,A2(_op["=>"],"width",A2($Basics._op["++"],$Basics.toString(col_percent),"%"))
                     ,A2(_op["=>"],"padding","5px")]);
   };
   ...
   var thumbnail_img_css = _U.list([A2(_op["=>"],"width","100%"),A2(_op["=>"],"border-radius","5px 5px 0px 0px")]);
   ...
   var thumbnail_price_css = _U.list([A2(_op["=>"],"display","inline")
                                     ,A2(_op["=>"],"color","green")
                                     ,A2(_op["=>"],"float","right")
                                     ,A2(_op["=>"],"margin-top","7px")
                                     ,A2(_op["=>"],"margin-bottom","10px")
                                     ,A2(_op["=>"],"margin-right","10px")
                                     ,A2(_op["=>"],"margin-left","10px")
                                     ,A2(_op["=>"],"font-weight","400")]);
   var thumbnail_css = F2(function (col_percent,listing) {
      return {container: $Html$Attributes.style(thumbnail_container(col_percent))
             ...
             ,photos: $Html$Attributes.style(thumbnail_img_css)
             ,categories: $Html$Attributes.style(thumbnail_categories_css)
             ,body: $Html$Attributes.style(hidden_div)};
   });
   var fullpage_container = _U.list([A2(_op["=>"],"padding","20px 40px"),A2(_op["=>"],"margin","0 auto")]);
   var fullpage_inner_container = _U.list([A2(_op["=>"],"width","100%"),A2(_op["=>"],"height","100%")]);
   var fullpage_title_css = _U.list([A2(_op["=>"],"text-align","center"),A2(_op["=>"],"font-size","30px")]);
   ...
   var fullpage_img_css = _U.list([A2(_op["=>"],"width","500px")
                                  ,A2(_op["=>"],"height","500px")
                                  ,A2(_op["=>"],"margin","auto")
                                  ,A2(_op["=>"],"border","1px solid #ddd")]);
   var fullpage_categories_css = _U.list([A2(_op["=>"],"margin-left","20px"),A2(_op["=>"],"font-size","20px")]);
   var fullpage_body_css = _U.list([A2(_op["=>"],"margin","20px 20px")]);
   var fullpage_button = _U.list([A2(_op["=>"],"height","100%")
                                 ,A2(_op["=>"],"border","none")
                                 ,A2(_op["=>"],"color","white")
   ...
   var fullpage_css = function (listing) {
      return {container: $Html$Attributes.style(fullpage_container)
             ...
             ,photos: $Html$Attributes.style(fullpage_img_css)
   ...
   var update = F2(function (action,listing) {    var _p0 = action;return _U.update(listing,{photos: A2($ImageViewer.update,_p0._0,listing.photos)});});
   var ImageActions = function (a) {    return {ctor: "ImageActions",_0: a};};
   var view = F3(function (col_percent,context,listing) {
      var _p1 = function () {
         var _p2 = listing.view;
         switch (_p2.ctor)
         {case "Thumbnail": return {ctor: "_Tuple2",_0: A2(thumbnail_css,col_percent,listing),_1: thumbnail_button_view(context)};
   ...
   var Fullpage = {ctor: "Fullpage"};
   var Thumbnail = {ctor: "Thumbnail"};
   var init = F2(function (p,listing) {
...
Elm.Listings.make = function (_elm) {
   ...
   if (_elm.Listings.values) return _elm.Listings.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   var fullpage_container_css = _U.list([A2(_op["=>"],"margin","0 10%")]);
   var toPixel = function (x) {    return A2($Basics._op["++"],$Basics.toString(x),"px");};
   var Context = F2(function (a,b) {    return {listingsAction: a,thumbnailAction: b};});
   ...
   var listingMatchQuery = F2(function (filter_words,listing) {
      return _U.eq(filter_words,_U.list([])) || _U.eq(filter_words,_U.list([""])) ? true : A3($List.foldl,
      F2(function (word,tf) {    return A2($List.member,word,listing.query) && tf;}),
      true,
      filter_words) ? true : false;
   });
   var filterListings = F3(function (filter_words,category,listing) {
      return A2(listingMatchQuery,filter_words,listing) && A2(listingMatchCategories,category,listing) ? _U.update(listing,
      {view: $Listing.Thumbnail}) : _U.update(listing,{view: $Listing.Hidden});
   });
   ...
   var view_listing = F3(function (col_percent,context,listing) {
      var listing_context = A3($Listing.Context,
      A2($Signal.forwardTo,context.listingsAction,ListingAction(listing.key)),
      context.thumbnailAction,
      A2($Signal.forwardTo,context.listingsAction,$Basics.always(FullpageAction(listing.key))));
      return A3($Listing.view,col_percent,listing_context,listing);
   });
   var makeTableRows = F4(function (_p0,context,listing,acc) {
      var _p1 = _p0;
      var _p2 = function () {
         var _p3 = acc;
         if (_p3.ctor === "[]") {
               return _U.crashCase("Listings",
               {start: {line: 166,column: 24},end: {line: 168,column: 41}},
               _p3)("Oh no! Acc was not initialized correctly in foldr");
            } else {
      ...
      var acc_head = _p2._0;
      var accs = _p2._1;
      var new_listing_html = A3(view_listing,_p1._1,context,listing);
      var new_head = _U.eq($List.length(acc_head),_p1._0) ? _U.list([_U.list([new_listing_html]),acc_head]) : _U.list([A2($List._op["::"],
      new_listing_html,
      acc_head)]);
      return A2($List.append,new_head,accs);
   });
   var view = F3(function (_p5,context,model) {
      var _p6 = _p5;
      var _p10 = _p6._1;
      var _p9 = _p6._0;
      var _p7 = function () {
         ...
         if (_p8.ctor === "ThumbnailView") {
               ...
               var num_cols = _U.cmp(number_of_listings,_p9) < 0 ? _U.list([{ctor: "_Tuple2"
                                                                            ,_0: "width"
                                                                            ,_1: A2($Basics._op["++"],
                                                                            $Basics.toString(number_of_listings * _p10),
                                                                            "%")}]) : _U.list([]);
               return {ctor: "_Tuple2"
                      ,_0: _U.list([$Html$Attributes.style(A2($List.append,listings_container_css,num_cols)),$Html$Attributes.id("thumbnail-container")])
                      ,_1: A2($List.map,
                      row_div,
                      $List.reverse(A3($List.foldl,A2(makeTableRows,{ctor: "_Tuple2",_0: _p9,_1: _p10},context),_U.list([_U.list([])]),filtered_listings)))};
            } else {
               return {ctor: "_Tuple2"
                      ,_0: _U.list([$Html$Attributes.style(fullpage_container_css),$Html$Attributes.id("fullpage-container")])
                      ,_1: A2($List.map,A2(view_listing,100,context),model.listings)};
            }
      }();
      var container_css = _p7._0;
      var listings_content = _p7._1;
   ...
   var Model = F2(function (a,b) {    return {view: a,listings: b};});
   var FullpageView = {ctor: "FullpageView"};
   var ThumbnailView = {ctor: "ThumbnailView"};
   var init = function (listingsList) {    return {view: ThumbnailView,listings: listingsList};};
   var update = F2(function (action,model) {
      var _p11 = action;
      switch (_p11.ctor)
      {case "ThumbnailAction": return _U.update(model,{view: ThumbnailView,listings: A2($List.map,A2(filterListings,_p11._0,_p11._1),model.listings)});
         case "FullpageAction": return _U.update(model,
           {view: FullpageView
           ,listings: A2($List.map,
           function (listing) {
              return _U.eq(listing.key,_p11._0) ? _U.update(listing,{view: $Listing.Fullpage}) : _U.update(listing,{view: $Listing.Hidden});
           },
           model.listings)});
         default: return _U.update(model,
           {listings: A2($List.map,
           function (listing) {
              return _U.eq(listing.key,_p11._0) ? A2($Listing.update,_p11._1,listing) : listing;
           },
           model.listings)});}
   });
...
Elm.Index.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Listing = Elm.Listing.make(_elm),
   $Listings = Elm.Listings.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm),
   ...
   var resizes = A2($Signal.map,Resize,$Window.dimensions);
   ...
   var view = F2(function (address,model) {
      ...
      var one_col_limit = 640;
      var w = $Basics.fst(model.meta.windowDim);
      var _p0 = _U.cmp(w,one_col_limit) < 0 ? {ctor: "_Tuple2",_0: 1,_1: 100} : _U.cmp(w,two_col_limit) < 0 ? {ctor: "_Tuple2",_0: 2,_1: 50} : _U.cmp(w,
      three_col_limit) < 0 ? {ctor: "_Tuple2",_0: 3,_1: 33} : {ctor: "_Tuple2",_0: 4,_1: 25};
      var col_limit = _p0._0;
      var col_percent = _p0._1;
      return A2($Html.div,
   ...
   var update = F2(function (action,model) {
      ...
      {case "HttpAction": return {ctor: "_Tuple2"
                                 ...
                                 ,_1: $Effects.none};
         case "Scroll": return _U.eq(_p1._0,true) && _U.eq(model.listings.view,$Listings.ThumbnailView) ? {ctor: "_Tuple2"
                                                                                                          ,_0: model
         ...
         case "HeaderAction": return {ctor: "_Tuple2",_0: _U.update(model,{header: A2($Header.update,_p1._0,model.header)}),_1: $Effects.none};
         case "SearchEnter": var metaModel = model.meta;
         ...
         case "ThumbnailAction": return {ctor: "_Tuple2"
                                        ...
                                        A2($Listings.ThumbnailAction,model.meta.searchFilter,model.meta.categoryFilter),
                                        model.listings)})
                                        ,_1: $Effects.none};
...
Elm.Main.make = function (_elm) {
   ...
   var app = $StartApp.start({init: $Index.init,update: $Index.update,view: $Index.view,inputs: _U.list([infiniteScroll,$Index.firstResize,$Index.resizes])});
   var main = app.html;
